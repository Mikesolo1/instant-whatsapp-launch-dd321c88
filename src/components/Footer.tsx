      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between">
          <div className="text-gray-400">
            &copy; {currentYear} S3. {t("footer.rights")} <br>* Деятельность компании Meta Platforms Inc. по реализации продуктов — социальных сетей Facebook и Instagram — на территории Российской Федерации запрещена решением суда.</br>
          </div>
